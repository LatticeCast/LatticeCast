...
Usage:
    docker compose exec -T test-e2e pytest auth/test_me_email_change.py -v
    E2E_SNAPSHOT=1 docker compose exec -T test-e2e pytest auth/test_me_email_change.py -v
"""
