...
Usage:
    docker compose exec -T test-e2e pytest auth/test_me_config_darkmode.py -v
    docker compose exec -T test-e2e pytest auth/test_me_config_darkmode.py -v --snapshot
"""
