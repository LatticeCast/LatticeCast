...
Usage:
    docker compose exec test-e2e pytest table_views/test_timeline_color_by.py -v
    docker compose exec test-e2e pytest table_views/test_timeline_color_by.py -v --snapshot
"""
