...
Run:
    docker compose exec -T test-e2e pytest workspace/test_member_remove.py -v
"""
...
def test_member_remove_loses_access(browser, authed_page, admin_token, snapshot) -> None:
    ...
    snap(page, "t50_02_member_removed", snapshot)
    ...
    snap(page2, "t50_03_member_denied", snapshot)
