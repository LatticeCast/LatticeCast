...
Usage:
    docker compose exec -T test-e2e pytest tables/test_column_tags_type.py -v
    docker compose exec -T test-e2e pytest tables/test_column_tags_type.py -v --snapshot
"""
