...
Usage:
    docker compose exec -T test-e2e pytest tables/test_column_option_add_remove.py -v
    docker compose exec -T test-e2e pytest tables/test_column_option_add_remove.py -v --snapshot
"""
