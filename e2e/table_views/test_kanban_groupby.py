...
Three pillars (developing-e2e v0.8.0):
...
Usage:
    docker compose exec e2e pytest table_views/test_kanban_groupby.py -v
    docker compose exec e2e pytest table_views/test_kanban_groupby.py -v --snapshot
"""
