...
Two-container architecture (per skill developing-e2e v0.7.0):
...
Usage:
    ...
    docker compose exec -T e2e pytest template/test_seo_framework.py -v
"""
...
def test_seo_framework(browser, admin_token):
    ...
    try:
        ...
        try:
            ...
            # sleep (see developing-e2e skill — banned patterns).
