...
<div class="relative flex min-h-screen flex-col">
	<!-- Top bar -->
	<header class="fixed top-0 right-0 left-0 z-30 flex h-12 items-center bg-blue-600 px-3 shadow">
		{#if menuOpen}
			<button
	...
	<main
		class="content-area flex-1 pt-12 dark:bg-gray-950"
		style="margin-left: {menuOpen ? '208px' : '0'};"
	>
		{@render children?.()}
	</main>
</div>
