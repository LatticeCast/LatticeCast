	...
	>
		...
		<nav data-testid="menu-nav" class="flex-1 space-y-1 px-4">
			<button
				...
				class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-left text-sm text-gray-700 transition hover:bg-blue-50 hover:text-blue-600"
			>
		...
		<div class="border-t border-gray-200 p-4">
			{#if $authStore?.role}
				{#if $authStore.userInfo}
					<div class="mb-3 flex items-center gap-2 px-2">
						...
						{:else}
							<div class="flex h-7 w-7 items-center justify-center rounded-full bg-blue-100 text-xs text-blue-600">
				...
				<button
					...
					class="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-gray-700 transition hover:bg-blue-50 hover:text-blue-600"
				>
					<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			{:else}
				<button
					...
					class="flex w-full items-center gap-3 rounded-lg bg-blue-600 px-3 py-2 text-sm font-semibold text-white transition hover:bg-blue-700"
				>
					<svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
