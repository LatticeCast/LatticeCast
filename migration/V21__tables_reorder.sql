...
INSERT INTO tables_new (workspace_id, table_id, columns, views, created_at, updated_at)
SELECT workspace_id, table_id, columns, views, created_at, updated_at FROM tables;
