...
-- Reorder tables columns: workspace_id, table_id, table_name, columns, views,
...
INSERT INTO tables_new (
    workspace_id, table_id, columns, views, created_at, updated_at
)
SELECT
    workspace_id,
    table_id,
...
-- Drop old table (CASCADE drops rows_table_id_fkey and other dependent
-- constraints)
...
-- Recreate unique constraint: table_id unique within workspace
